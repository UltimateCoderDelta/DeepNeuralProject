...
def predictive_models(request):
    ...
    return render(request,"deepneural/predictive_models.html", context)

def anxio(request):
    return render(request, "deepneural/anxio.html")

def home(request):
    return render(request, "deepneural/home.html")

def pneumonia_form(request):
    return render(request, "deepneural/pneumonia_form.html")
...
def deepneural_blog(request):
    ...
    return render(request, "deepneural/deepneural_blog.html", context)

def deepneural_blog_one(request):
    return render(request, "deepneural/deepneural_intro.html")
